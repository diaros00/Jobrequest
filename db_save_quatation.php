...
if (isset($_POST["num_req"])) {
    ...
    if (isset($_POST["product"]) && isset($_POST["amount"]) && isset($_POST["unit"]) && isset($_POST["price"])) {
        ...
        if ($product[0] !== '' && $amount[0] !== '' && $unit[0] !== '' && $price[0] !== '') {
            ...
            $sql = "INSERT INTO quatation (name_request,department,tel,email,date_time_stamp,date_picker,comment,num_req,approver_code) VALUES ('$name_request','$department','$tel','$email',GETDATE(),'$date_picker','$comment','$num_req','$ManagerApprove')";
            sqlsrv_query($conn, "SET NAMES UTF8");
